...
<table border="1">
    ...
    <c:forEach var="khachhang" items="${list}">
        <tr>
            ...
            <td>${khachhang.lhl_tenkh}</td>
            <td>${khachhang.lhl_email}</td>
            <td>${khachhang.lhl_sdt}</td>
            <td>${khachhang.lhl_diachi}</td>
            <!-- Sửa lại link edit và delete -->
            <td><a href="${pageContext.request.contextPath}/KhachHang/edit/${khachhang.lhl_makh}">Edit</a></td>
            <td><a href="${pageContext.request.contextPath}/KhachHang/delete/${khachhang.lhl_makh}"
