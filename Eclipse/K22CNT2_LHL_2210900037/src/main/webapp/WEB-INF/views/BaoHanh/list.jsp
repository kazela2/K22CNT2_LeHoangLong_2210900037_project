    ...
    <table border="1">
        ...
        <c:forEach var="bh" items="${list}">
            <tr>
                ...
                <td>${bh.lhl_masp}</td> 
                <td><fmt:formatDate value="${bh.lhl_ngaybatdau}" pattern="yyyy/MM/dd" /></td>
                <td><fmt:formatDate value="${bh.lhl_ngayketthuc}" pattern="yyyy/MM/dd" /></td>
                <td>${bh.lhl_trangthai}</td>
                <td><a href="${pageContext.request.contextPath}/BaoHanh/edit/${bh.lhl_mabaohanh}">Edit</a></td>
                <td><a href="${pageContext.request.contextPath}/BaoHanh/delete/${bh.lhl_mabaohanh}"
